...
#python main.py --output_dir $root_dir/output/mvts/finetune/$1 --name futs_finetune_$1 --records_file Regression_records.xls --data_class futs --epochs 30 --lr 0.001 --batch_size 64 --optimizer RAdam  --pos_encoding learnable --task regression --data_dir $root_dir/data/ --pattern "ZCE_CH_$1/train/daily_frame.20231.parquet" --val_pattern ZCE_CH_UR/val/daily_frame.2023110?.parquet #"ZCE_CH_$1/val/daily_frame.*.parquet" 
